...
const Login: React.FC<LoginProps> = ({ onLogin, isAuthenticated }) => {
    ...
    const iniciarSesion = async (event: FormEvent) => {
        ...
        const rutaServicio = "https://www.wildcat.games/services/autorpgservices/login.php";
        let formData = new FormData();
        formData.append("usuario", dataForm.get("usuario") as string);
        formData.append("clave", dataForm.get("clave") as string);
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        ...
                        <form onSubmit={(event) => iniciarSesion(event)}>
                            <div className="mb-2">
                                <input type="text" className="form-control" required name="usuario" placeholder="Usuario" />
                            </div>
                            <div className="mb-2">
                                <input type="password" className="form-control" required id="txtClave" name="clave" placeholder="Contraseña" />
                                <input
                                    type="checkbox"
